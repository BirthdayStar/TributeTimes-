...
- The remaining items (index 1 onward) are "on this day in history" trivia from different years, all on ${day}th ${monthName(month)} — this varied-year trivia format is intentional for these only. Each of these items' body: no more than 220 characters, ending on a complete sentence (the first item's own body length is specified separately above).
